...
Overall, we were able to reproduce the effects found by Medimorec et al. (2017). Although the statistics are slightly different, as we used a slightly different test that informs us of the same outcome, conceptually we find support for Medimorec et al.'s claim that essays written in a less fluent way are more lexically diverse and use less frequent words. 
