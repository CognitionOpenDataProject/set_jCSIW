...
Reproduction of **Table 1**: means, standard deviations, and Cohen's d of essay discriptive measures across the two conditions.
```{r}
...
Reproduction of **Table 2**: means, standard deviations, and Cohen's d of lexical diversity and word frequency across the two conditions, Coh-Metrix indices. 
```{r}
...
Reproduction of **Table 3**: means, standard deviations, and Cohen's d of lexical diversity and word frequency across the two conditions, TAACO and TAALES indices.
```{r}
